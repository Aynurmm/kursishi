...
fetchDataFromServer(
  ...
  function (movie) {
    ...
    const bookingticket = document.createElement("button");
    bookingticket.classList.add("booknow");
    bookingticket.innerHTML = 'Book now';
    movieDetail.appendChild(bookingticket);
